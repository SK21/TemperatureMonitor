...
String GetPage2()
{
	...
	st += "      }";
	st += "input.largerCheckbox {transform: scale(2);}";
	st += "";
	...
	st += "          <td><input type='password' class = 'InputCell' size = '20' name = 'prop2' value = '" + String(MDL.Password) + "' ID = Text2></td>";
	st += "        </tr>";
	st += "";
	st += "        <tr>";
	...
	st += "          <td><input class='InputCell' size='20' name='prop4' value='" + String(MDL.Name) + "' ID=Text4></td>";
	st += "        </tr>";
	st += "      </table>";
	st += "";
	st += "<br>";
