String GetPage1()
{
	...
	st += "          <td><input class='InputCell' size='25' name='prop1' value='" + String(Props.SSID) + "' ID=Text1></td>";
	st += "        </tr>";
	st += "        <tr>";
	st += "          <td align='left'>Password </td>";
	st += "          <td><input class='InputCell' size='25' name='prop2' value='" + String(Props.Password) + "' ID=Text2></td>";
	st += "        </tr>";
	st += "        <tr>";
	st += "          <td align='left'>ID </td>";
	st += "          <td><input class='InputCell' size='25' name='prop3' value='" + String(Props.ID) + "' ID=Text3></td>";
	st += "        </tr>";
	st += "        <tr>";
	st += "          <td align='left'>Sleep Interval (minutes) </td>";
	st += "          <td><input class='InputCell' size='25' name='prop4' value='" + String(Props.SleepInterval) + "' ID=Text4></td>";
	st += "        </tr>";
	st += "      </table>";
