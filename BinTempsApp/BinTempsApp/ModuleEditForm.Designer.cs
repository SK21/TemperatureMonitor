namespace BinTempsApp
{
    partial class ModuleEditForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            const int col1 = 12, col2 = 170;
            const int row0 = 14, row1 = 47, row2 = 80, row3 = 122;

            // lblMac
            this.lblMac.AutoSize = true;
            this.lblMac.Location = new System.Drawing.Point(col1, row0 + 3);
            this.lblMac.Text     = "MAC:";

            // lblMacValue
            this.lblMacValue.AutoSize = true;
            this.lblMacValue.Location = new System.Drawing.Point(col2, row0 + 3);
            this.lblMacValue.Font     = new System.Drawing.Font("Consolas", 9F);

            // lblName
            this.lblName.AutoSize = true;
            this.lblName.Location = new System.Drawing.Point(col1, row1 + 3);
            this.lblName.Text     = "Name (max 10 chars):";

            // txtName
            this.txtName.Location  = new System.Drawing.Point(col2, row1);
            this.txtName.MaxLength = 10;
            this.txtName.Size      = new System.Drawing.Size(150, 23);

            // lblId
            this.lblId.AutoSize = true;
            this.lblId.Location = new System.Drawing.Point(col1, row2 + 3);
            this.lblId.Text     = "ID (0 = unregistered):";

            // nudId
            this.nudId.Location = new System.Drawing.Point(col2, row2);
            this.nudId.Maximum  = 255;
            this.nudId.Minimum  = 0;
            this.nudId.Size     = new System.Drawing.Size(60, 23);

            // btnSave
            this.btnSave.Location = new System.Drawing.Point(col2, row3);
            this.btnSave.Size     = new System.Drawing.Size(90, 28);
            this.btnSave.Text     = "Save";
            this.btnSave.Click   += new System.EventHandler(this.btnSave_Click);

            // btnCancel
            this.btnCancel.Location    = new System.Drawing.Point(col2 + 100, row3);
